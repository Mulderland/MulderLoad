...
SectionGroup "Bug fixes"
    Section "Fix corrupted levels (if detected)"
        ...
        ${If} $0 != "1"
            !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/bugfixes/x_levels_fix.7z" \
    ...
    Section "Fix JPEG errors on modern CPUs"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/bugfixes/rlmfc%20for%20ryzen.rar" \
                                "https://www.mediafire.com/file_premium/ravyaa9mo2536z9/rlmfc_for_ryzen.rar/file" \
    ...
    Section "Fix sound (DSOAL v1.31a + 07-02-2022 fix)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/bugfixes/DSOAL%20v1.31a%20with%2007-02-2022%20fix%20%5BRepack-MLD%5D.7z" \
                                "https://www.mediafire.com/file_premium/trj9myz5nqc9u19/DSOAL_v1.31a_with_07-02-2022_fix_%255BRepack-MLD%255D.7z/file" \
                                "DSOAL.7z" "b917abedd17f27bcad3d121a8d0208376e2cc055"
        !insertmacro NSIS7Z_EXTRACT "DSOAL.7z" ".\" "AUTO_DELETE"
...
SectionGroup "Difficulty fixes"
    Section "Remove broken Adaptive Difficulty"
        ...
        SetOutPath "$INSTDIR"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/payne_difficulty.7z" \
                                "https://community.pcgamingwiki.com/files/file/2807-max-payne-flat-difficulty-vanilla-pc-values/#14073" \
...
SectionGroup /e "Improvements"
    Section "Widescreen Fix (by ThirteenAG)"
        ...
        !insertmacro DOWNLOAD_2 "https://github.com/ThirteenAG/WidescreenFixesPack/releases/download/mp1/MaxPayne.WidescreenFix.zip" \
                                "https://cdn1.mulderload.eu/games/max-payne/gfx/MaxPayne.WidescreenFix.zip" \
    ...
    Section /o "Upscaled Textures (from MP Remastered 1.3)"
        ...
        !insertmacro DOWNLOAD_2 "https://www.moddb.com/downloads/start/285759" \
                                "https://cdn1.mulderload.eu/games/max-payne/textures/MaxPayne.exe" \
                                "_maxpayne_4gb.exe.bak" "219c679703a7f15728e950ec9ae03096898aabce"
        AddSize 4836

        # Upscaled textures
        SetOutPath "$INSTDIR\@mulderload\mp_remastered"

        !insertmacro DOWNLOAD_2 "https://www.moddb.com/addons/start/172811" \
                                "https://cdn1.mulderload.eu/games/max-payne/gfx/MPRemastered1.3.zip" \
                                "MPRemastered1.3.zip" "cf48d7ce2676831d36c0b00bb76c9b57"
    ...
    Section "New Weapons sounds (by TheSorrow55)"
        ...
        !insertmacro DOWNLOAD_1 "https://www.nexusmods.com/maxpayne/mods/38?tab=files&file_id=88" \
                                "MP-weapons sounds-38-V1-1759949431.rar" "9f8fd64393b8fbf0136ae32b3ae721a44162d359"
...
SectionGroup "Translation patches (texts only)"
    Section /o "French patch"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_fr-FR.ras" \
                                "https://www.mediafire.com/file_premium/soeggmrmqnye1vw/MP1_TextOnly_fr-FR.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_fr-FR.ras.bak" "05e4c31c68a924537818357daea9ee06c50848bf"
        AddSize 69239
    SectionEnd

    Section /o "Italian patch"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_it-IT.ras" \
                                "https://www.mediafire.com/file_premium/blyv9vwll348p46/MP1_TextOnly_it-IT.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_it-IT.ras.bak" "a215ef9e635cc000e77cf83fbbfa3b8b77689fd8"
        AddSize 69287
    SectionEnd

    Section /o "Polish patch"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_pl-PL.ras" \
                                "https://www.mediafire.com/file_premium/f2px2yiqpe47udo/MP1_TextOnly_pl-PL.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_pl-PL.ras.bak" "800b2dcc64bec7519962cfc8c3bf83bf3d027d3c"
        AddSize 69083
    SectionEnd

    Section /o "Portuguese patch (Brazil)"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_pt-BR.ras" \
                                "https://www.mediafire.com/file_premium/k9jigadl2ajpj5i/MP1_TextOnly_pt-BR.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_pt-BR.ras.bak" "bd1ab683f22d4389a05a63aec41b6957c040cf71"
        AddSize 67453
    SectionEnd

    Section /o "Russian patch"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_ru-RU.ras" \
                                "https://www.mediafire.com/file_premium/4hti7fmaaubxke1/MP1_TextOnly_ru-RU.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_ru-RU.ras.bak" "b05a9186a38444cbe17097a7944af80c7c4f6e74"
        AddSize 72284
    SectionEnd

    Section /o "Spanish patch"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/max-payne/translation/MP1_TextOnly_es-ES.ras" \
                                "https://www.mediafire.com/file_premium/zfjibntkq3aehq4/MP1_TextOnly_es-ES.ras/file" \
                                "$INSTDIR\_MP1_TextOnly_es-ES.ras.bak" "30573c689a5b00934a7d406351d18e1ff756fe4d"
        AddSize 71145
    SectionEnd
SectionGroupEnd
