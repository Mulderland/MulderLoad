...
Section "Update Steam to GOG version (2024 re-release)"
    ...
    !insertmacro DOWNLOAD_1 "https://cdn.de.mulderload.eu/games/alpha-protocol/update/Steam to GOG 2024 [MLD].7z" \
                            "Steam to GOG 2024 [MLD].7z" \
                            "d8c4d4c5123d8f9c4bdabc3d45621fbef230763a"

    !insertmacro NSIS7Z_EXTRACT "Steam to GOG 2024 [MLD].7z" ".\" "AUTO_DELETE"
    skip_section:
SectionEnd
