...
Section "Kentie's Launcher (Deus Exe) v8.1"
    ...
    !insertmacro DOWNLOAD_2 "https://kentie.net/article/dxguide/files/DeusExe-v8.1.zip" \
                            "https://cdn.mulderload.eu/games/deus-ex/impr_gfx/DeusExe-v8.1.zip" \
                            "DeusExe.zip" \
                            "57838689dc9ce652c0da0a75fa3f42867122f3b8"
    ...
    !insertmacro DOWNLOAD_2 "https://aka.ms/vs/17/release/vc_redist.x86.exe" \
                            "https://cdn.mulderload.eu/redistributables/microsoft/vc2015-2022/VC_redist.x86.exe" \
                            "vc_redist.x86.exe" \
...
Section "Kentie's D3D10 renderer v29"
    ...
    !insertmacro DOWNLOAD_2 "https://kentie.net/article/d3d10drv/files/d3d10drv-v29.zip" \
                            "https://cdn.mulderload.eu/games/deus-ex/impr_gfx/d3d10drv-v29.zip" \
                            "d3d10drv.zip" \
                            "07bf26fe348116830c5c86326bb112b74519b0d4"
    ...
    !insertmacro DOWNLOAD_2 "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x86.exe" \
                            "https://cdn.mulderload.eu/redistributables/microsoft/vc2010/vcredist_x86.exe" \
                            "vcredist_x86.exe" \
                            "2222fc008e469fec77d0d291877f357c6e1eb16d"

    ExecWait '"vcredist_x86.exe" /install /quiet /norestart' $0
    Delete "vcredist_x86.exe"

    # DirectX 9 End-User Runtime Web Installer
    !insertmacro DOWNLOAD_2 "https://download.microsoft.com/download/1/7/1/1718CCC4-6315-4D8E-9543-8E28A4E18C4C/dxwebsetup.exe" \
                            "https://cdn.mulderload.eu/redistributables/microsoft/dx9/dxwebsetup.exe" \
                            "dxwebsetup.exe" \
...
Section "Textures Pack (from New Vision v1.5)"
    ...
    !insertmacro DOWNLOAD_1 "https://www.moddb.com/mods/new-vision/downloads/new-vision-15" \
                            "New_Vision_v1-5.exe" \
                            "31eb1ead889a8c1230906d833e644403"
...
Section /o "DXM's Patch FR v1.8b7 (French Subtitles)"
    ...
    !insertmacro DOWNLOAD_2 "https://www.dxm.be/host/files/DeusEx_FrenchPatch18b7.exe" \
                            "https://cdn.mulderload.eu/games/deus-ex/translation/DeusEx_FrenchPatch18b7.exe" \
                            "DeusEx_FrenchPatch18b7.exe" \
                            "3769f35d20f2705d4c2a347e6c8db1a5c8033ae1"
