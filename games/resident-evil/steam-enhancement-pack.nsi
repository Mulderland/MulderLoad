...
Section "High Quality Audio v2020 (by lexas87)"
    ...
    !insertmacro DOWNLOAD_RANGE "https://cdn.mulderload.eu/games/resident-evil/impr_audio/Resident Evil HQ Sound Pack v8.5 [Repack-MLD].7z.001" \
                                "Resident Evil HQ Sound Pack v8.5 [Repack-MLD].7z.001" \
                                "f95afa7be268de4394f0a595a4c12207a90c09c6" \
                                2

    !insertmacro NSIS7Z_EXTRACT "Resident Evil HQ Sound Pack v8.5 [Repack-MLD].7z.001" ".\" "AUTO_DELETE"
    Delete "Resident Evil HQ Sound Pack v8.5 [Repack-MLD].7z.002"
    AddSize 1020355
SectionEnd
...
!else
    ...
    Function .onInit
        ...
        StrCpy $SELECT_STEAM_FOLDER "4249100_Biohazard"
    FunctionEnd
!endif
