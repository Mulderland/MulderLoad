...
SectionGroup /e "ThirteenAG's Ultimate ASI Loader"
    ...
    Section "Lyall's SHfFix v0.0.1"
        ...
        !insertmacro DOWNLOAD_2 "https://codeberg.org/Lyall/SHfFix/releases/download/0.0.1/SHfFix_0.0.1.zip" \
                                "https://cdn.mulderload.eu/games/silent-hill-f/impr_gfx/SHfFix_0.0.1.zip" \
                                "SHfFix.zip" \
                                "8346265b6afb034d9477a86be79f5251853112d1"
...
Function .onInit
    ...
    StrCpy $SELECT_INSTALL_PATH "C:\Program Files (x86)\GOG Galaxy\Games\SILENT HILL f"
    StrCpy $SELECT_STEAM_FOLDER "SILENT HILL f"
FunctionEnd
