...
SectionGroup "The Simpsons: Hit & Run (Full Installation)"
    ...
    Section "Remove legacy disc check"
        ...
        ${If} $9 == ${EXE_HASH_EUROPE}
            ...
            !insertmacro DOWNLOAD_1 "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/update/Europe (Both)/Simpsons.exe.xdelta" "$INSTDIR\Simpsons.exe.xdelta" "a07ccd46911000d5700577d1dfda6b69383c3cbd"
        ${ElseIf} $9 == ${EXE_HASH_FRANCE}
            DetailPrint " // Apply french diff on France version"
            !insertmacro DOWNLOAD_1 "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/update/France (Original)/Simpsons.exe.xdelta" "$INSTDIR\Simpsons.exe.xdelta" "a77f6a73f772597af678dd4ca4c51c2d9771313f"
        ${ElseIf} $9 == ${EXE_HASH_GERMANY}
            DetailPrint " // Apply german diff on Germany version"
            !insertmacro DOWNLOAD_1 "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/update/Germany (Rerelease)/Simpsons.exe.xdelta" "$INSTDIR\Simpsons.exe.xdelta" "6b35dd31b0f135ce5507afc68f442227ebd79dcc"
        ${ElseIf} $9 == ${EXE_HASH_SPAIN}
            DetailPrint " // Apply spanish diff on Spain version"
            !insertmacro DOWNLOAD_1 "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/update/Spain (Original)/Simpsons.exe.xdelta" "$INSTDIR\Simpsons.exe.xdelta" "10ddf112d4ee8d0bce9c76c388e0c176511078cc"
        ${ElseIf} $9 == ${EXE_HASH_USA}
            DetailPrint " // Apply english diff on USA version"
            !insertmacro DOWNLOAD_1 "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/update/USA (Original)/Simpsons.exe.xdelta" "$INSTDIR\Simpsons.exe.xdelta" "cb69fed2706d95c8bd0c36970c7a4732e1f1e5e3"
        ${Else}
...
SectionGroup /e "Improvements" impr
    Section "Lucas' Launcher v1.26.1 (recommended)" impr_lucas
        ...
        !insertmacro DOWNLOAD_2 "https://modbakery.donutteam.com/release-branch-version-files/download/6/46/75/71" \
                                "https://cdn.mulderload.eu/games/the-simpsons-hit-and-run/impr_misc/Lucas Launcher [Main] [1.26.1].zip" \
                                "LucasLauncher.zip" \
                                "a6959d64130c9193720aa2c6bd78c36ff9f31ff6"
