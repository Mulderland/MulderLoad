...
Section "Widescreen fix (by nemesis2000) + dgVoodoo2"
    ...
    !insertmacro DOWNLOAD_1 "https://community.pcgamingwiki.com/files/file/2789-hitman-contracts-widescreen-fix/" \
                            "Hitman Contracts Widescreen Fix.zip" \
                            "ac56b015d4422e43305bc1139327905eab3a24f1"
...
Section "Add missing Direct3D effects (by burntshrimp)"
    ...
    !insertmacro DOWNLOAD_1 "https://community.pcgamingwiki.com/files/file/3537-hitman-contracts-directx-fix-asi-plugin/" \
                            "HitmanContractsFix-ASI.7z" \
                            "0d3a8bd43c5bbabf5977a67b130796d3ed605423"
...
Section "Add Xinput Controller support (by mutantx20)"
    ...
    !insertmacro DOWNLOAD_1 "https://community.pcgamingwiki.com/files/file/2821-hitman-contracts-controller-fix/" \
                            "Hitman - Contracts controller fix.7z" \
                            "e5998180058614e925be8fd6e4e28091436274ac"
...
Function .onInit
    ...
    StrCpy $SELECT_INSTALL_PATH "C:\Program Files (x86)\GOG Galaxy\Games\Hitman Contracts"
    StrCpy $SELECT_STEAM_FOLDER "Hitman Contracts"
FunctionEnd
