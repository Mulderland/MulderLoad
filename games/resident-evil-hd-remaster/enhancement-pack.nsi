...
Section "Fusion Fix (by ThirteenAG)"
    ...
    !insertmacro DOWNLOAD_2 "https://github.com/ThirteenAG/WidescreenFixesPack/releases/download/re1/ResidentEvil.FusionFix.zip" \
                            "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/ResidentEvil.FusionFix.zip" \
                            "ResidentEvil.FusionFix.zip" "d0073d31f482b1dbae1abdeeb37bf41d745ad316"
...
SectionGroup "Bug fixes"
    ...
    Section "ERR09 Crash Fix (by jayandsilentrage)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/bugfixes/d3d9.dll%20(G-Sync%20Fix)-180-1-0-1773517313.7z" \
                                "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/180?tab=files&file_id=361" \
                                "d3d9.dll (G-Sync Fix).7z" "a54e0a605939f370da7b8ea89311a2c2d77df982"
    ...
    Section "Lab lift fix (by Kayael)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/bugfixes/Lab%20lift%20fix-98-1-0-1714239591.zip" \
                                "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/98?tab=files&file_id=197" \
                                "Lab lift fix-98-1-0-1714239591.zip" "ed2b3ba606a510b186116acb263f789f4cea059a"
    ...
    Section "Normalized Soundtrack (by zeikar & MrBunny)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/bugfixes/Normalized%20Soundtrack%20Mod%20%5BRepack-MLD%5D.7z.001" \
                                "https://www.mediafire.com/file_premium/f07uh90l6ez9vxs/Normalized_Soundtrack_Mod_%255BRepack-MLD%255D.7z.001/file" \
                                "Normalized Soundtrack Mod [Repack-MLD].7z.001" "8e3632372fb1746839b865d4f5adeecabbecfa03"
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/bugfixes/Normalized%20Soundtrack%20Mod%20%5BRepack-MLD%5D.7z.002" \
                                "https://www.mediafire.com/file_premium/4vsdxnhem11dn7e/Normalized_Soundtrack_Mod_%255BRepack-MLD%255D.7z.002/file" \
                                "Normalized Soundtrack Mod [Repack-MLD].7z.002" "72742aabf86f01cb0ace4513f26e89507c2839ae"
...
SectionGroup /e "Graphical improvements"
    Section "[Characters] Retcon Pack (by Bloodyhunter)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/gfx/Retcon%20Pack%20(REmaster)-20-2-2-1640281803.rar" \
                                "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/20?tab=files&file_id=96" \
                                "Retcon Pack (REmaster)-20-2-2-1640281803.rar" "c8f160186c902404d07cedd9d1dd6db1e5873147"
    ...
    Section /o "[Textures] RESCALE (by Arcturium)"
        ...
        !insertmacro DOWNLOAD_1 "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/102?tab=files&file_id=201" \
                                "RESCALE Version 1.0-102-1-0-1715439796.zip" "54cce42d12991ac72af60628f99c25726c6d037b"
        ...
        !insertmacro DOWNLOAD_1 "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/102?tab=files&file_id=205" \
                                "RESCALE V1 - Hotfix 2-102-1-0-1715618408.zip" "a13b02c56abb5b447f9f50fa23670fb2fa5cebc0"
    ...
    Section /o "[Videos] RE-Enhance FMVs (by SonicB00M)"
        SetOutPath "$INSTDIR"
        # Alert, requires tu play at 1080p. Don't download if you have a lower resolution (Steam Deck for example)

        !insertmacro DOWNLOAD_2 "https://www.moddb.com/downloads/start/292442" \
                                "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/gfx/RE-ENHANCE_RE1R_FMV-Pack_V1.1.zip" \
                                "RE-ENHANCE_RE1R_FMV-Pack_V1.1.zip" "2988f79371211e3e56cf855a4d75eabf"
    ...
    Section "East stairs lightning fix (by Kayael or nayef)"
        ...
        ${If} $R0 == "1"
            ...
            !insertmacro DOWNLOAD_1 "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/158?tab=files&file_id=324" \
                                    "RESCALE fix E stairs lightning-158-1-0-1766106497.zip" "3fd487023cef635a0a07bc7975e445949d848fb5"
        ...
        ${Else}
            ...
            !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/gfx/East%20stairs%20lightning%20fix-99-1-0-1714746376.zip" \
                                    "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/99?tab=files&file_id=198" \
                                    "East stairs lightning fix-99-1-0-1714746376.zip" "449cb5d97e6d9020224dae0cf9d1e66a1e7e09f9"
    ...
    Section "Real time graphics mod (by masterotaku)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/gfx/REmake_settings_mod.zip" \
                                "https://s3.amazonaws.com/masterotaku/Resident+Evil+1/REmake_settings_mod.zip" \
                                "REmake_settings_mod.zip" "288a684f3dc835d0b19c74d705d817fbcd257610"
...
SectionGroup /e "Other improvements"
    Section "Gamecube Font Mod (by MrBunny)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/other/FontModUpdate2.zip" \
                                "https://www.mediafire.com/file_premium/3gngqsy730vsh2r/FontModUpdate2.zip/file" \
                                "FontModUpdate2.zip" "d10a9012866a155a829c925e6b1b0fda7861d5d9"
    ...
    Section "Remastered Inventory Icons (by AndehX)"
        ...
        !insertmacro DOWNLOAD_2 "https://cdn1.mulderload.eu/games/resident-evil-hd-remaster/other/inventory_icons_v1-97-1-1708634320.zip" \
                                "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/97?tab=files&file_id=190" \
                                "inventory_icons_v1-97-1-1708634320.zip" "2807f054efb4cbf27072e69c13960a3aacfaa6e5"
    ...
    Section "Weapons Sounds Mod (by TheSorrow55)"
        ...
        !insertmacro DOWNLOAD_1 "https://www.nexusmods.com/residentevilbiohazardhdremaster/mods/75?tab=files&file_id=180" \
                                "REHD SOUND MOD V2-75-v2-1707853350.rar" "c01e21b1989065c05b81733d081435dc601b94af"
