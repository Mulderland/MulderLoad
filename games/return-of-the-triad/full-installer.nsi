...
Section "Return of the Triad v1.6 + GZDoom v4.14"
    ...
    !insertmacro DOWNLOAD_2 "https://github.com/ZDoom/gzdoom/releases/download/g4.14.2/gzdoom-4-14-2-windows.zip" \
                            "https://cdn.mulderload.eu/tools/zdoom/gzdoom-4-14-2-windows.zip" \
                            "gzdoom.zip" \
                            "2b3e7eac9e13bf88d27865165a1596de5778eb1a"

    !insertmacro NSISUNZ_EXTRACT "gzdoom.zip" ".\" "AUTO_DELETE"

    !insertmacro DOWNLOAD_1 "https://www.moddb.com/mods/return-of-the-triad/downloads/return-of-the-triad-16" \
                            "rott_tc_16.zip" \
                            "e67988147c4a745d07d30090a54c5a39"
...
Section "Addon - Scream of the Triad"
    ...
    !insertmacro DOWNLOAD_1 "https://www.moddb.com/mods/return-of-the-triad/addons/scream-of-the-triad" \
                            "ROTT_ScreamTriad.zip" \
                            "a6e0a77da276117df18a4c9e9216dfd3"
...
Section /o "Freedoom: Phase 1 (if you don't have Doom or Doom 2 installed)"
    ...
    !insertmacro DOWNLOAD_2 "https://github.com/freedoom/freedoom/releases/download/v0.13.0/freedoom-0.13.0.zip" \
                            "https://cdn.mulderload.eu/games/freedoom/base/freedoom-0.13.0.zip" \
                            "freedoom.zip" \
                            "957bc049d165d8454c6aa35849e9ca0da1ddfcea"
