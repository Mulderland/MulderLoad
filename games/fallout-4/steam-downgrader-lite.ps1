...
Invoke-WebRequest -Uri "https://cdn.de.mulderland.com/games/fallout-4/steam-downgrader/1.11.221_lite/steam_depots_deltas.zip" -OutFile "steam_depots_deltas.zip"
