...
SectionGroup /e "Downgrade Steam version (v1.11.221) to" version
    ...
    Section "v1.10.163 (pre-next-gen)" version_1_10_163
        ...
        MessageBox MB_YESNO|MB_DEFBUTTON2 "Delete CC files that were not included in v1.10.163?$\r$\n$\r$\nClick No if you use mods that require these files, or if you're unsure." IDYES cc_delete IDNO cc_keep
        cc_delete:
