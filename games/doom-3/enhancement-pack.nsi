...
SectionGroup /e "Dhewm3 v1.5.5 + GUI Wide Patch"
    Section
        ...
        # Install dhewm3
        !insertmacro DOWNLOAD_2 "https://github.com/dhewm/dhewm3/releases/download/1.5.5/dhewm3-1.5.5_win32.zip" \
                                "https://cdn.mulderload.eu/games/doom-3/impr_misc/dhewm3-1.5.5_win32.zip" \
                                "dhewm3.zip" \
                                "7fb23ced41b902c2ca14fa0da37f30f7656a7087310bc70b367f3257ddb0a7f7"
    ...
    Section
        ...
        !insertmacro DOWNLOAD_2 "https://github.com/dhewm/dhewm3/releases/download/1.5.5/dhewm3-wide-guis-v0.2.zip" \
                                "https://cdn.mulderload.eu/games/doom-3/impr_gfx/dhewm3-wide-guis-v0.2.zip" \
                                "dhewm3-wide-guis.zip" \
                                "e01a5834b0f2d4fb7fb1bcfbceea099db0871469d41faaba57fe19d395045322"
    ...
    Section "[DLC] The Lost Mission (require RoE)" lost_mission
        ...
        !insertmacro DOWNLOAD_1 "https://www.moddb.com/mods/the-lost-mission/downloads/d3-lost-mission" \
        ...
        !insertmacro DOWNLOAD_2 "https://github.com/dhewm/dhewm3/releases/download/1.5.5/dhewm3-mods-1.5.5_win32.zip" \
                                "https://cdn.mulderload.eu/games/doom-3/impr_misc/dhewm3-mods-1.5.5_win32.zip" \
                                "dhewm3-mods.zip" \
                                "06b31ad92be6b32810005c96e38665c625d4d726cbfb58a29b6f54381c86a6c8"
...
Section "Textures Pack x4 v1.1 (by GrowlingGuy41)"
    ...
    !insertmacro DOWNLOAD_1 "https://www.moddb.com/mods/gg41-doom3/downloads/x4-texture-upscale-for-doom-3-v11-roe" \
                            "Doom3_GG41_textures_RoE.zip" \
                            "73e8e1cc90dce64b3f1fa743b131ce6e"
